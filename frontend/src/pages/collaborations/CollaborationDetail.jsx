...
function Field({ label, value }) {
  ...
  return (
    <div>
      <p className="text-xs font-medium mb-1" style={{ color: "#6b6b80" }}>
        {label}
      </p>
...
export default function CollaborationDetail() {
  ...
  return (
    <div className="max-w-3xl">
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="text-sm font-medium" style={{ color: "#fb923c" }}>
              {collab.creatorName}
              <span className="mx-2" style={{ color: "#4a4a60" }}>
                ×
              </span>
      ...
      {/* Details grid */}
      <div
        className="rounded-2xl p-6 grid grid-cols-2 gap-5"
      ...
      >
        ...
        <Field
          ...
          value={
            collab.dueDate
              ? new Date(collab.dueDate).toLocaleDateString("en-US", {
                  year: "numeric",
                  month: "long",
                  day: "numeric",
                })
        ...
        {collab.personalNotes && (
          <div className="col-span-2">
            ...
            <div
              className="p-3 rounded-xl text-sm text-white leading-relaxed whitespace-pre-wrap"
        ...
        <div>
          ...
          <p className="text-sm" style={{ color: "#6b6b80" }}>
            {new Date(collab.updatedAt).toLocaleDateString("en-US", {
              year: "numeric",
              month: "short",
              day: "numeric",
            })}
