...
export default function CollaborationForm() {
  ...
  return (
    <div className="max-w-2xl">
      <Link
        to={isEdit ? `/collaborations/${id}` : "/collaborations"}
      ...
      <div className="mb-8">
        ...
        <p style={{ color: "#6b6b80" }}>
          {isEdit ? "Update collaboration details" : "Log a new creator deal"}
        </p>
      </div>
      ...
      >
        ...
        <Field label="Personal Notes">
          <textarea
            ...
            placeholder="Your thoughts, rate card, next steps..."
            onFocus={(e) =>
              (e.target.style.borderColor = "rgba(249,115,22,0.6)")
            }
            onBlur={(e) => (e.target.style.borderColor = "#2a2a38")}
