    ...
    <div className="max-w-2xl">
      ...
      <div className="mb-8">
        ...
        <p style={{ color: "#6b6b80" }}>
          {isEdit ? "Update campaign details" : "Launch a new brand campaign"}
        </p>
      </div>
      ...
      >
        ...
        <Field label="Requirements / Content Brief">
          <textarea
            ...
            className={inputClass}
            style={{ ...inputStyle, resize: "none" }}
            placeholder="Deliverables, tone, dos and don'ts..."
            onFocus={(e) =>
              (e.target.style.borderColor = "rgba(124,58,237,0.6)")
            }
            onBlur={(e) => (e.target.style.borderColor = "#2a2a38")}
        ...
        <Field label="Internal Notes">
          <textarea
            ...
            className={inputClass}
            style={{ ...inputStyle, resize: "none" }}
            placeholder="Private notes (not shared with creator)..."
            onFocus={(e) =>
              (e.target.style.borderColor = "rgba(124,58,237,0.6)")
            }
            onBlur={(e) => (e.target.style.borderColor = "#2a2a38")}
