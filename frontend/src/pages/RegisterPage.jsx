...
const inputClass =
  "w-full px-4 py-3 rounded-xl text-sm text-white outline-none transition-all";
const inputStyle = {
                    ...
                    style={
                      form.role === value
                        ? {
                            background:
                              value === "creator"
                                ? "linear-gradient(135deg, rgba(236,72,153,0.2), rgba(124,58,237,0.15))"
                                : "linear-gradient(135deg, rgba(124,58,237,0.2), rgba(99,102,241,0.15))",
                            border: `1px solid ${value === "creator" ? "rgba(236,72,153,0.5)" : "rgba(124,58,237,0.5)"}`,
                          }
                        : {
                            backgroundColor: "#1a1a28",
                            border: "1px solid #2a2a38",
