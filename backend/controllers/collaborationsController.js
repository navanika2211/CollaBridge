...
import * as Collaboration from "../models/Collaboration.js";

// GET /api/collaborations
export async function getAllCollaborations(req, res, next) {
  try {
    const db = getDB();
    const filter = Collaboration.buildFilter(req.query);
